...
function renderCards() {
  ...
  filtered.forEach(function(pkg) {
    var message = 'Halo ' + storeName + ', saya mau membeli paket ' + pkg.operatorName + ' ' + pkg.quota + ' GB seharga Rp' + pkg.price + ' dengan masa aktif ' + pkg.validity + '. Apakah masih tersedia?';
    ...
    card.innerHTML =
      ...
      '<a href="' + waLink + '" class="btn-whatsapp" target="_blank" rel="noopener noreferrer">' +
        waSvg + 'Beli via WhatsApp' +
      '</a>';

    grid.appendChild(card);
  });

  // Trigger fade-in untuk kartu baru
